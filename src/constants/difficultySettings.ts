...
export const difficultySettings: Record<DifficultyLevel, { time: number; aiLevel: number }> = {
  easy: { time: 10, aiLevel: 0.3 },      // 30% accuracy - misses blocks often
  medium: { time: 7, aiLevel: 0.5 },     // 50% accuracy - basic strategic play
  hard: { time: 5, aiLevel: 0.7 },       // 70% accuracy - good tactical awareness
  nightmare: { time: 3.5, aiLevel: 0.85 }, // 85% accuracy - advanced minimax play
  insane: { time: 2, aiLevel: 0.95 },    // 95% accuracy - deep strategic analysis
  godlike: { time: 1.2, aiLevel: 0.98 }, // 98% accuracy - near-perfect play

...
export const difficultySettings: Record<DifficultyLevel, { time: number; aiLevel: number }> = {
  ...
  medium: { time: 2, aiLevel: 0.5 },         // 50% accuracy - basic strategic play
  hard: { time: 1.6, aiLevel: 0.7 },         // 70% accuracy - good tactical awareness
  nightmare: { time: 1.3, aiLevel: 0.85 },   // 85% accuracy - advanced minimax play
  insane: { time: 1.1, aiLevel: 0.95 },      // 95% accuracy - deep strategic analysis
